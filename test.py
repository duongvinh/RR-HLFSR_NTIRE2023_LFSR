...
def main(args):
	...
	with torch.no_grad():
		...
		for index, test_name in enumerate(test_Names):
			...
			psnr_iter_test, ssim_iter_test, LF_name,time_total = test(test_loader, device, net, save_dir)

			if args.test_NTIRE2023_LFSR == 0:
			...
			if args.test_NTIRE2023_LFSR == 0:
				print('Test on %s, psnr/ssim is %.2f/%.3f, Time---%f' % (test_name, psnr_epoch_test, ssim_epoch_test,time_total))
